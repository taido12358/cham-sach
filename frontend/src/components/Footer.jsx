      ...
      <div className="container" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 32 }}>
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 16 }}>
            ...
            <div className="serif" style={{ fontSize: 20, fontWeight: 700, color: 'var(--cream)' }}>Trang Sách</div>
          </div>
        ...
        <div>
          ...
          <div style={{ display: 'flex' }}>
            <input placeholder="email của bạn" style={{ flex: 1, padding: '8px 12px', borderRadius: '2px 0 0 2px', fontSize: 13, background: 'rgba(255,255,255,0.1)', color: 'var(--cream)', border: 'none', outline: 'none' }} />
            <button style={{ padding: '0 16px', borderRadius: '0 2px 2px 0', fontWeight: 500, fontSize: 13, background: 'var(--amber)', color: 'var(--forest)' }}>OK</button>
          </div>
        </div>
      </div>
