    ...
    <div className="paper-texture" style={{ minHeight: '80vh', display: 'flex', alignItems: 'center' }}>
      <div className="container" style={{ maxWidth: 480, padding: '64px 24px', width: '100%' }}>
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          ...
          <h1 className="serif" style={{ fontSize: 36, fontWeight: 700, color: 'var(--heading)', marginBottom: 8 }}>Tham gia CLB</h1>
        ...
        <div style={{ textAlign: 'center', marginTop: 24, fontSize: 14, color: 'var(--sage)' }}>
          Đã có tài khoản? <Link href="/dang-nhap" style={{ color: 'var(--heading)', fontWeight: 500, textDecoration: 'underline' }}>Đăng nhập</Link>
        </div>
      </div>
    </div>
  );
